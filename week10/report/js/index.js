...
$(document).ready(function() {
    setTimeout(function () {
        $(".main-intro-content, .main-scroll").fadeIn();
    }, 700);
...
// 버튼 클릭시 스크롤 이동
function customScrollFunction(target) {
    $('html, body').animate({
...
function chanPage() {
    window.location.href = "page/channel.html";
}

function mapPage() {
    window.location.href = "page/map.html";
}